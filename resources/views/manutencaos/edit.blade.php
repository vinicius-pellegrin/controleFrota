    ...
    <div class="card">
        <div class="places-buttons">
            <div class="row justify-content-center">
                ...
                <p class="category">Alterando a descrição da aManutenção - {{$manutencao->id}}</p>
                </h5>
              </div>
            </div>
         </div>
         ...
         {!! Form::open(['url'=>"manutencao/$manutencao->id/update", 'method'=>'put']) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group{{ $errors->has('descricao') ? ' has-danger' : '' }}">
                            ...
                            {!! Form::text('descricao', $manutencao->descricao, ['type'=>'text','class'=> 'form-control', 'placeholder'=>'Descreva a manutencao']) !!}
