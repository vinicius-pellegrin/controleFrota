    ...
    <div class="card">
        <div class="places-buttons">
            <div class="row justify-content-center">
                ...
                <p class="category">Alterando a descrição das medidas do Pneu Codigo - {{$pneu->id}}</p>
                </h5>
              </div>
            </div>
         </div>
         ...
         {!! Form::open(['url'=>"pneu/$pneu->id/update", 'method'=>'put']) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group{{ $errors->has('largura') ? ' has-danger' : '' }}">
                            ...
                            {!! Form::number('largura', $pneu->largura, ['type'=>'number','class'=> 'form-control', 'placeholder'=>'Largura do Pneu']) !!}
                    ...
                    <div class="col-md-6">
                        <div class="form-group{{ $errors->has('altura') ? ' has-danger' : '' }}">
                            {!!Form::label ('altura','Atltura') !!}   
                            {!! Form::number('altura', $pneu->altura, ['class'=> 'form-control', 'placeholder'=>'Altura do Pneu']) !!}
                    ...
                    <div class="col-md-6">
                        <div class="form-group{{ $errors->has('roda') ? ' has-danger' : '' }}">
                            ...
                            {!! Form::number('roda', $pneu->roda, ['class'=> 'form-control', 'placeholder'=>'tamanho da Roda']) !!}
                    ...
                    <div class="col-md-6">
                        <div class="form-group{{ $errors->has('marca') ? ' has-danger' : '' }}">
                            ...
                            {!! Form::text('marca', $pneu->marca, ['class'=> 'form-control', 'placeholder'=>'Marca do Pneu']) !!}
