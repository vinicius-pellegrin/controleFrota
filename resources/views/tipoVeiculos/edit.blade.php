    ...
    <div class="card">
        <div class="places-buttons">
            <div class="row justify-content-center">
                ...
                <p class="category">Alterando a descrição do Tipo de Veiulo- {{$tipoVeiculo->id}}</p>
                </h5>
              </div>
            </div>
         </div>
         ...
         {!! Form::open(['url'=>"tipoVeiculo/$tipoVeiculo->id/update", 'method'=>'put']) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group{{ $errors->has('descricao') ? ' has-danger' : '' }}">
                            ...
                            {!! Form::text('descricao', $tipoVeiculo->descricao, ['type'=>'text','class'=> 'form-control', 'placeholder'=>'Descreva a tipoVeiculo']) !!}
