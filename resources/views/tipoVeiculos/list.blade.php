                              ...
                              <table class="table">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                    <a href="{{route('tipoVeiculo.edit',['id'=>$man->id])}}" class="btn-sm btn-sucsess">Editar</a>
                                    <a href="{{route('tipoVeiculo.destroy',['id'=>$man->id])}}" class="btn-sm btn-danger">Excluir</a>
                                    </td>
                                  </tr>
                                  @endforeach
                                </tbody>
